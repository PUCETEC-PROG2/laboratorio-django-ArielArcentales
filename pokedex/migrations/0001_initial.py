    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='trainer_images/')),
            ],
        ),
        migrations.CreateModel(
            name='Pokemon',
            fields=[
                ...
                ('type', models.CharField(choices=[('C', 'Tierra'), ('E', 'Electrico'), ('D', 'Planta'), ('B', 'Fuego'), ('A', 'Agua'), ('F', 'Lagartija')], max_length=30)),
